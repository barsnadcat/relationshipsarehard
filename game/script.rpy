...
label start:
    ...
    show she neutral
    if isHobby:
        me smiling "До речі, я збираюсь поїхати до космодрому Куру, подивитися на запуск Аріан 5!"
        she dress surprised "Нічого собі!"
        she dress neutral "Коли це буде?\nЯк же ж я без твоїх послуг?"
    ...
    "Раніше я дізнався, що вона - директор компанії, тому і сама дуже гарно заробляє."
    ...
    menu:
        ...
        "Відтягнути її від огорожі.":
            ...
            if itsOkToEscapeFromReality:
                she robe disappointed "Пробач. Я тебе налякала?"
                if isHobby:
                    me disturbed "Дуже."
                else:
        ...
        "Краще випити снодійного.":
            ...
            me neutral "Краще випити снодійного."
            me serious "Хтось може бути внизу і постраждати ні за що."
            if itsOkToEscapeFromReality:
                stop music fadeout 2.0
                ...
                she robe disappointed "Прослідкуєш, щоб мене поховали поряд з чоловіком?"
                ...
                if isHobby:
                    ...
                    me neutral "Так."
                    me serious "Але спочатку напиши записку, щоб мене не посадили."
                she robe sad "Потримаєш мене за руку поки я буду засинати?"
                me "Звісно."
                show she robe smiling
                pause 0.5
                jump redPill
...
label redPill:
    scene bg black
    with fade
    "Зранку я викликав поліцю і швидку."
    "Парамедики зафіксували факт смерті."
    "Поліції я сказав що нічого не знав про її чоловіка, ви лише недавно познайомилися, а вранці знайшов її записку."
    "Родичив з її боку розшукати не вдалося. Родичі зі сторони чоловіка не хотіли про неї нічого чути, та навіть чинили опір її похованню поряд з ним."
    "Але мені вдалося виконати її останнє прохання."
    jump titleDrop
